...
export default class TronLink extends BrowserExtension {
  ...
  _onTronlinkEvent (e) {
    ...
    switch (message.action) {
      case 'tabReply':
        break
      case 'connect':
        console.log('TronLink connected', message.isTronLink)
        break
      case 'disconnect':
        console.log('TronLink disconnected', message.isTronLink)
        break
  ...
  async switch () {
    throw new Error('TronLink does not support network switch')
  }
