...
export const AllsToEventsSchema = new mongoose.Schema({
  addr: { type: String, index: true, unique: true },
  amount: { type: Number },
  mint_hash: { type: String },
  code: { type: String, index: true, unique: true }
}, {  timestamps: { createdAt: 'created' }})

AllsToEventsSchema.method('toJSON', function() {
  return pick(this, 'addr amount mint_hash code'.split(' '))
})