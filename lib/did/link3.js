...
function _parseLink3ProfileWithHandle (data, handle) {
...
export async function getProfileFromAddress (address) {
  ...
  return _parseLink3ProfileWithHandle(link3Profile, primary.handle)
}
...
export async function getProfileFromHandle (handle) {
  ...
  return { addr, ..._parseLink3ProfileWithHandle(link3Profile, handle) }
}
