...
const getProfilesByHandles = gql`
query getProfilesByHandles($handles: [String!]!){
...
export async function getMultiProfilesByHandles(handles) {
  try {
    // if not found, will return { profileByHandle: [] }
    return await gqlClient.request(getProfilesByHandles, { handles })
  } catch (e) {
    return
  }
}
